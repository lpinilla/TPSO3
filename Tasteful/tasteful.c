...
char ** fetch_all_suites(int n_of_suites_found){
    ...
    call_command("ls ../Tests/ | grep -P '[tT][eE][sS][tT][_-]*[a-z]*[A-Z]*[0-9]*[_-]*[a-z]*[A-Z]*.tasty'", buffer);
    //cleaning buffer
...
int find_tests(){ //seguro se puede re optimizar a partir del comando anterior pero bueno
    ...
    call_command("ls ../Tests/ | grep -P '[tT][eE][sS][tT][_-]*[a-z]*[A-Z]*[0-9]*[_-]*[a-z]*[A-Z]*.tasty' | wc -l", buffer);
    int ret = atoi(buffer);
    free(buffer);
    return ret;
}
